...
/* ──────────────────────────────────────────────────────────────────────────
 * Dclaw Tailwind design tokens
 * ──────────────────────────────────────────────────────────────────────────
 *
 * This config layers Dclaw's own visual language on top of shadcn/ui:
 *
 ...
 *      ...) we add three Dclaw-private groups:
 ...
 *
 *   4. Naming — All Dclaw-private tokens live under their own top-level
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
       ...
       * change only edits the values here. Dclaw's full size ladder
       * (combining Tailwind defaults + Dclaw additions, smallest first):
       *
       *   ┌──────────────┬──────────┬─────────────┬──────────────────────────────┐
       ...
       *   B. Dclaw brand tokens (brand / skill) — plain hex values that
       *      do not change between light and dark themes.
       *   C. Dclaw surface tokens (surface.{modal,input,sidebar}) — use
